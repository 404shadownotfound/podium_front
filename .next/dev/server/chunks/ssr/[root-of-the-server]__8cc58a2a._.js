...
;
const metadata = {
    title: "TechQuest - Learn Free Tech Alternatives for Free",
    description: "Master modern tech solutions that replace expensive Windows software. Play, learn, and compete with users worldwide—all completely free.",
    generator: "v0.app",
    icons: {
        icon: [
            {
