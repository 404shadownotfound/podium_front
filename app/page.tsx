  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <section id="why" className="relative max-w-7xl mx-auto px-6 py-20 border-t border-cyan-500/10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4 text-balance">
            Why Learn With <span className="text-cyan-400">TechQuest?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-bold text-white text-balance">
              How TechQuest <span className="text-cyan-400">Works</span>
            </h2>
      ...
      <section id="video" className="relative max-w-7xl mx-auto px-6 py-20 border-t border-cyan-500/10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4 text-balance">
            See TechQuest in <span className="text-cyan-400">Action</span>
          </h2>
          <p className="text-slate-400 text-lg">
      ...
      <footer className="border-t border-cyan-500/10 bg-gradient-to-b from-slate-950/50 to-slate-950/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-lg font-semibold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-4">
                TechQuest
              </h3>
              <p className="text-slate-400 text-sm">Leading the blockchain revolution with innovative solutions.</p>
            </div>
            <div>
          ...
          <div className="border-t border-slate-800 pt-8 text-center text-slate-400 text-sm">
            <p>&copy; 2025 TechQuest. All rights reserved. | Privacy Policy | Terms of Service</p>
          </div>
        </div>
      </footer>
    </div>
